  ...
  hover(props: any, monitor: any, component: any) {
    ...
    if (!item.key && item.onHover) {
      ...
      props.editor.change((change: any) => {
        let parent = change.value.document.getParent(props.children.key);
      ...
      props.editor.change((change: any) => {
        let parent = change.value.document.getParent(item.key);
...
export default compose<BlockProps, ExternalBlockProps>(
